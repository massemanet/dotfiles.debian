...
(custom-set-variables
 ...
 '(package-selected-packages
   '(cask shut-up transient flycheck magit markdown-mode rust-mode yaml-mode solarized-theme smart-mode-line projectile pallet nyan-mode kubernetes highlight-parentheses gruvbox-theme go-mode flymake-rust flymake-jslint flycheck-rust exec-path-from-shell erlang dockerfile-mode cargo bazel-mode))
